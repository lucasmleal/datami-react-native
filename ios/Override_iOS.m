...
+(void)swizzle
{
    ...
    Class unityAppDelegate = NSClassFromString(@"AppDelegate");
    Class overrideAppDelegate = DatamiAppDelegate.class;
    
    // See log messages for the sake of this tutorial.
    [EPPZSwizzler setLogging:YES];
    
    [EPPZSwizzler addInstanceMethod:@selector(handleNotification:)
...
//    [EPPZSwizzler replaceInstanceMethod:@selector(handleNotification:)
//                                ofClass:unityAppDelegate
//                              fromClass:overrideAppDelegate];
}
